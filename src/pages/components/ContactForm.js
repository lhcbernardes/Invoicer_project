      ...
      <div className="py-10 lg:px-20 xl:max-w-7xl xl:mx-auto">
        <div>
          ...
          >
            ...
            <article>
              <div className="flex items-center justify-between gap-2 flex-wrap">
                ...
                {formik.errors.name ? <small className="text-sm text-rose-500">{formik.errors.name}</small> : null}
              </div>
              <input
                type="text"
                name="name"
            ...
            <article>
              <div className="flex items-center justify-between gap-2 flex-wrap">
                ...
                {formik.errors.email ? <small className="text-sm text-rose-500">{formik.errors.email}</small> : null}
              </div>
              <input
                type="email"
                name="email"
            ...
            <article>
              <div className="flex items-center justify-between gap-2 flex-wrap">
                ...
                {formik.errors.message ? (
                  <small className="text-sm text-rose-500">{formik.errors.message}</small>
                ) : null}
              </div>
              <textarea
                name="message"
          ...
          <div className="px-10 pt-5 pb-10 sm:px-28 lg:px-20 xl:max-w-7xl xl:mx-auto">
            <h4 className="mb-3 text-left text-xl tracking-tight">This is how your form submission will look like:</h4>
