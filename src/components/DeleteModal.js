    ...
    <>
      <div className="inline-block transition-all duration-200 bg-black bg-opacity-25 fixed left-0 right-0 bottom-0 top-0 z-20">
        <div className="w-9/12 max-w-2xl bg-white p-8 rounded shadow fixed left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
          <h2 className="text-3xl mb-4">Realmente deseja delet!</h2>
          <p className="text-slate-600 mb-10">
            Tem certeza de que deseja excluir este item? Observe que esta ação é irreversível. Portanto, proceda com
            cautela...
          </p>
          ...
          <ul className="flex flex-wrap gap-6 items-start md:items-start justify-between">
            <li>
              <button
                ...
                className="flex items-center justify-start md:justify-center gap-2 bg-blue-500 py-2 px-4 rounded text-white hover:ring-4 hover:ring-blue-300 hover:bg-blue-600 transition-all duration-150"
              >
                Não, voltar
              </button>
            </li>
